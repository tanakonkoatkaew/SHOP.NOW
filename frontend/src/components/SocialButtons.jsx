// Shared OAuth button styling + brand marks.
// White buttons with the brand logo in colour keep the storefront's black/white
// look while staying recognisable (and within each brand's usage guidelines).

export const socialBtn =
  'w-full flex items-center justify-center gap-3 py-3.5 bg-white border-2 border-gray-200 ' +
  'text-black font-bold rounded-xl text-sm cursor-pointer transition-all ' +
  'hover:border-black hover:bg-[#F2F0F1]'
