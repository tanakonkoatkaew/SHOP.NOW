        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 py-3.5 bg-[#1877F2] hover:bg-[#0C63D4] text-white font-bold rounded-xl transition-all shadow-lg shadow-[#1877F2]/20 hover:shadow-[#1877F2]/35 text-sm cursor-pointer"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
